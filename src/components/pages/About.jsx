...
import above from '../assets/other_images/above.jpg'
import bib from '../assets/other_images/bib.jpg'
            ...
            <div>
                ...
                <div className='missionContainer'>
                    <div className='missionVision'>
                        <div className='dipoplex'>
                            <div id='dip1'>
                                <div className='aboutmiss'>
                                <h3>Vision</h3>
                                ...
                                <div className='aboutmiss'>
                                <h3>Mission</h3>
                                    To galvanize business individuals, organizations, institutions, and nations towards the evolution of the economy of the African continent<br/>
                                </div>
                            </div>
                            <div id='dip2'>
                                <div>
                                <h3>Core Values</h3>
                                <div className='aboutmiss' id='innerdip2'>
                                    ...
                                    <img src={bib} alt='bib' className='bibimage'/>
                            </div>
                        </div><br /><br />
                    </div>
                </div>
                <div className='abtsecondlayer'>
                    <div className='innerbbtContainer'>
                        ...
                        <div className='dipos' >
                            <div className='aboutcontent' id='dipi'>
