...
import alab from "../assets/other_images/alab.png";
        ...
        <div className="busi-school">
          <div className="businesscontainer">
            ...
            <div className="businesstext">
              ...
              high-performing executives. The School is built on the belief that
              sustainable economic growth depends on capable leadership, ethical
              business practices, and globally competitive enterprises. Through
              industry-relevant education and practical engagement, THE EDGE
              Business School bridges the gap between theory and real-world
              application, equipping participants with the mindset and skills
              required to succeed in complex business environments.
            </div>
          </div>
            ...
            <div className="businesssecond-line">
              ...
              <div className="businesstext">
                ...
                <div>
                  ...
                  innovative training and development, fostering global
                  competitiveness and ethical business practices."
                  <br />
                </div>
                ...
                <div>
                  ...
                  providing world-class education and practical skills that
                  address the unique challenges and opportunities in the African
                  business landscape."
                  <br />
                </div>
            ...
            <div className="theprofbusiness">
              ...
              <div className="progsides">
                <p>
                  ...
                  capability and business acumen for current and emerging
                  leaders. It focuses on strategic thinking, decision-making,
                  operational excellence, and financial management, enabling
                  participants to lead effectively, drive organisational
                  performance, and manage growth in competitive markets.
                </p>
                <p>
                  <strong>
                    Globalization of Indigenous Business Content (GIBC)
                  </strong>
                  : The GIBC program is a unique initiative aimed at positioning
                  indigenous businesses for global relevance. It supports
                  entrepreneurs in refining local products, services, and
                  business models to meet international standards while
                  preserving cultural identity and value. The program equips
                  participants with the tools needed to scale beyond local
                  markets and compete globally.
                </p>
                <p>
                  <strong>Executive Education</strong> : Our Executive Education
                  programs are tailored for senior leaders and executives
                  seeking advanced insight into leadership, governance,
                  strategy, and innovation. These programs provide a high-level
                  learning environment that combines global best practices with
                  regional context, supporting executives in navigating
                  complexity, managing risk, and driving long-term value
                  creation.
                </p>
              </div>
            </div>
          ...
          <div className="financeContainer">
            <div className="insidefinancePositioning">
              <div className="alabcontent">
                ...
                <p>
                  The A-LAB program is designed as a comprehensive journey for
                  leaders and teams who want to elevate their effectiveness,
                  collaboration, and long-term impact. It blends practical tools
                  with strategic frameworks, ensuring participants not only
                  learn but also apply concepts that drive measurable
              ...
              <div className="packagesContainer">
                ...
                <div className="allPackages">
                  <div className="packagesinfo">
                    ...
                    <div className="packagewriteup">
                      ...
                      <p>
                        ...
                        <br />
                        <br />
                        Downloadable resources: slides and recorded sessions
                        <br />
                        <br />
                        Access to an exclusive online community for networking
                        and peer learning
                        <br />
                        <br />
                        Certificate of participation (e-certificate)
                        <br />
                        <br />
                        This package provides flexibility and affordability,
                        perfect for professionals who prefer remote learning but
                        still want structured resources and certification
                        <br />
                        <br />
                      </p>
                  ...
                  <div className="packagesinfo">
                    ...
                    <hr className="ruler" />
                    <div className="packagewriteup">
                      <div className="PackagePrice" id="multipleprice">
                        Exclusive to corporate organizations enrolling multiple
                        executives:
                      </div>
                      <p>
                        <strong>₦150,000</strong> (3 slots)
                        <br />
                        <br />
                        <strong>₦200,000</strong> (5 slots)
                        <br />
                        <br />
                        <strong>Includes all Executive Package benefits</strong>
                        <br />
                        <br />
                        Designed for organizations seeking collective leadership
                        development and team alignment
                        <br />
                        <br />
                        This package offers value for organizations by combining
                        cost efficiency with collective growth, ensuring
                        executives learn together and apply strategies
                        cohesively
                        <br />
                        <br />
                      </p>
                  ...
                  <div className="packagesinfo">
                    ...
                    <div className="packagewriteup">
                      ...
                      <p>
                        Physical class attendance <br />
                        <br />
                        Interactive workshops: case studies, group discussions,
                        and practical exercises
                        <br />
                        <br />
                        Networking opportunities: face-to-face connections with
                        industry experts and executives
                        <br />
                        <br />
                        Business audit & strategy review: tailored insights into
                        organizational strengths and gaps
                        <br />
                        <br />
                        Business toolkit: slides, recorded materials, and
                        ...
                        <br />
                        <br />
                        Ideal for immersive learning and direct mentorship.
                        <br />
                        <br />
                      </p>
              ...
              <div className="insidebus" id="fort2">
                ...
                <div className="underimage">
                  ...
                  <p>
                    ...
                    enterprises, and expand their impact. Our programs are
